...
public class LTHRadioButton: UIView {
    ...
    private var diameter: CGFloat = 18

    private let deselectable: Bool = false
    ...
    private var innerBorderWidth: CGFloat {
        return innerCircle.frame.width * 0.5
    }
    ...
    public func setButtonStyle(style: RadioButtonStyle) {
        let innerCircleDiameter = diameter / 1.6
        self.innerCircle.layer.cornerRadius = style == .circle ? innerCircleDiameter * 0.5 : 4
    }
    ...
    private func circleBorderColor() -> CABasicAnimation {
        ...
        borderColor.beginTime      = layer.lth_currentMediaTime + 0.18
    ...
    public func setStateWithoutAction(isSelected: Bool) {
    ...
    @objc private func toggleState() {
        ...
        guard deselectable else { return }
        deselect()
    }
    ...
    public init(style: RadioButtonStyle,
                diameter: CGFloat = 18,
        ...
        commonInit(style: style, diameter: diameter, selectedColor: selectedColor, deselectedColor: deselectedColor)
    }
    ...
    required public init?(coder aDecoder: NSCoder) {
        ...
        commonInit(style: .circle, diameter: frame.size.width, selectedColor: nil, deselectedColor: nil)
    }
    ...
    private func commonInit(style: RadioButtonStyle, diameter: CGFloat, selectedColor: UIColor?, deselectedColor: UIColor?) {
        let innerCircleDiameter = diameter / 1.6
        ...
        innerCircle.layer.cornerRadius = style == .circle ? innerCircleDiameter * 0.5 : 4
