...
//  DoorDash
//
//  Created by Marvin Zhan on 7/14/19.
...
//    }
    ...
    override func initialLayoutAttributesForAppearingItem(at itemIndexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        let newAttribtues = attributes.copy() as! UICollectionViewLayoutAttributes
        newAttribtues.alpha = 0
        newAttribtues.frame = CGRect(x: -3 * attributes.frame.width, y: attributes.frame.minY, width: attributes.frame.width, height: attributes.frame.height)
...
//        let newAttribtues = attributes.copy() as! UICollectionViewLayoutAttributes
//        newAttribtues.alpha = 0
//        newAttribtues.frame = CGRect(x: -attributes.frame.width, y: attributes.frame.minY, width: attributes.frame.width, height: attributes.frame.height)
//        return newAttribtues
//    }
}
