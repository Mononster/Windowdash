...
extension NavigationAddressHeaderView {
    ...
    private func setupLabels() {
        ...
        addressTitleLabel.font = ApplicationDependency.manager.theme.fontSchema.heavy12
        ...
        addressContentLabel.font = ApplicationDependency.manager.theme.fontSchema.medium18
